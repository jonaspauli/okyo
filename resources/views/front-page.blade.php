          ...
          $link = get_sub_field('link');
            ...
            <div class="flex flex-col second-callout">
              <div class="w-2/3 flex flex-col self-center">
                <h2 class="text-center tracking-tight text-6xl drop-shadow-lg self-center pb-5"><?php the_sub_field('headline'); ?></h2>
                <p class="text-center self-center pb-5 text-2xl drop-shadow-lg font-medium"><?php the_sub_field('text'); ?></p>
                <?php 
                    $link = get_sub_field('link');
                    if( $link ): 
                        $link_url = $link['url'];
      ...
      <?php if( have_rows('callout_3') ): ?>
          ...
          $link = get_sub_field('link');
            ...
            <div class="flex flex-col third-callout">
              <div class="w-2/3 flex flex-col self-center">
                <h2 class="text-center tracking-tight text-6xl  self-center pb-5 drop-shadow-lg"><?php the_sub_field('headline'); ?></h2>
                <p class="text-center self-center pb-5 text-2xl font-medium drop-shadow-lg"><?php the_sub_field('text'); ?></p>
                <?php 
                    $link = get_sub_field('link');
                    if( $link ): 
                        $link_url = $link['url'];
